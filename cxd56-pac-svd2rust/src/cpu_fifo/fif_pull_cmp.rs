...
///Field `PULL_CMP` writer - RX data read complete
...
///`write(|w| ..)` method takes [`fif_pull_cmp::W`](W) writer structure
impl crate::Writable for FifPullCmpSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FIF_PULL_CMP to value 0
