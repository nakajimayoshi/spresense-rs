///Register `APP_TILE_CLK_GATING_ENB` reader
pub type R = crate::R<AppTileClkGatingEnbSpec>;
///Register `APP_TILE_CLK_GATING_ENB` writer
...
///Field `TILE_CLK_GATING_ENB(0-11)` reader - Enable clock gating
...
///Field `TILE_CLK_GATING_ENB(0-11)` writer - Enable clock gating
...
///`read()` method returns [`app_tile_clk_gating_enb::R`](R) reader structure
impl crate::Readable for AppTileClkGatingEnbSpec {}
///`write(|w| ..)` method takes [`app_tile_clk_gating_enb::W`](W) writer structure
impl crate::Writable for AppTileClkGatingEnbSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets APP_TILE_CLK_GATING_ENB to value 0
