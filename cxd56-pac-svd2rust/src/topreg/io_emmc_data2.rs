///Register `IO_EMMC_DATA2` reader
pub type R = crate::R<IoEmmcData2Spec>;
///Register `IO_EMMC_DATA2` writer
pub type W = crate::W<IoEmmcData2Spec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoEmmcData2Spec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoEmmcData2Spec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoEmmcData2Spec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoEmmcData2Spec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for EMMC_DATA2 pin

You can [`read`](crate::Reg::read) this register and get [`io_emmc_data2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_emmc_data2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoEmmcData2Spec;
impl crate::RegisterSpec for IoEmmcData2Spec {
    type Ux = u32;
}
///`read()` method returns [`io_emmc_data2::R`](R) reader structure
impl crate::Readable for IoEmmcData2Spec {}
///`write(|w| ..)` method takes [`io_emmc_data2::W`](W) writer structure
impl crate::Writable for IoEmmcData2Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_EMMC_DATA2 to value 0x0101_0100
impl crate::Resettable for IoEmmcData2Spec {
