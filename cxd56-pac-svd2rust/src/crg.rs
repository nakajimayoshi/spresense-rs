...
impl RegisterBlock {
    ...
    ///0x40 - CPU/Peripheral clock gating control
    #[inline(always)]
    pub const fn ck_gate_ahb(&self) -> &CkGateAhb {
        &self.ck_gate_ahb
    }
}
/**GEAR_AHB (rw) register accessor: Gear ratio (n/m) for AHB
...
pub mod gear_ahb;
/**GEAR_IMG_UART (rw) register accessor: IMG UART clock setting
...
/**GEAR_IMG_SPI (rw) register accessor: IMG SPI clock setting
...
/**GEAR_PER_SDIO (rw) register accessor: SDIO clock setting
...
/**GEAR_PER_USB (rw) register accessor: USB clock setting
...
/**GEAR_M_IMG_VENB (rw) register accessor: VENB_M clock setting
...
/**GEAR_N_IMG_VENB (rw) register accessor: VENB_N clock setting
...
/**GEAR_IMG_WSPI (rw) register accessor: IMG WSPI clock setting
...
/**CKEN_EMMC (rw) register accessor: eMMC clock setting
...
///eMMC clock setting
pub mod cken_emmc;
/**RESET (rw) register accessor: Reset control
...
///Reset control
pub mod reset;
/**CK_GATE_AHB (rw) register accessor: CPU/Peripheral clock gating control
