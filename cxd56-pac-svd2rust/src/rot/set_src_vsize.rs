///Register `SET_SRC_VSIZE` reader
pub type R = crate::R<SetSrcVsizeSpec>;
///Register `SET_SRC_VSIZE` writer
...
///`read()` method returns [`set_src_vsize::R`](R) reader structure
impl crate::Readable for SetSrcVsizeSpec {}
///`write(|w| ..)` method takes [`set_src_vsize::W`](W) writer structure
impl crate::Writable for SetSrcVsizeSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SET_SRC_VSIZE to value 0
