///Register `JPG_NSTRG_SIZE` reader
pub type R = crate::R<JpgNstrgSizeSpec>;
///Register `JPG_NSTRG_SIZE` writer
...
///`read()` method returns [`jpg_nstrg_size::R`](R) reader structure
impl crate::Readable for JpgNstrgSizeSpec {}
///`write(|w| ..)` method takes [`jpg_nstrg_size::W`](W) writer structure
impl crate::Writable for JpgNstrgSizeSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets JPG_NSTRG_SIZE to value 0
