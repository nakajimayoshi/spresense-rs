///Register `SET_SRC_HSIZE` reader
pub type R = crate::R<SetSrcHsizeSpec>;
///Register `SET_SRC_HSIZE` writer
...
///`read()` method returns [`set_src_hsize::R`](R) reader structure
impl crate::Readable for SetSrcHsizeSpec {}
///`write(|w| ..)` method takes [`set_src_hsize::W`](W) writer structure
impl crate::Writable for SetSrcHsizeSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SET_SRC_HSIZE to value 0
