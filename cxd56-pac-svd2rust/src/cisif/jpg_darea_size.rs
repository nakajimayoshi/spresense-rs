#[doc = "Register `JPG_DAREA_SIZE` reader"]
pub type R = crate::R<JpgDareaSizeSpec>;
#[doc = "Register `JPG_DAREA_SIZE` writer"]
...
#[doc = "`read()` method returns [`jpg_darea_size::R`](R) reader structure"]
impl crate::Readable for JpgDareaSizeSpec {}
#[doc = "`write(|w| ..)` method takes [`jpg_darea_size::W`](W) writer structure"]
impl crate::Writable for JpgDareaSizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets JPG_DAREA_SIZE to value 0"]
