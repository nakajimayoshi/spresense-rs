...
#[doc = "`read()` method returns [`acnv_p0_dst2::R`](R) reader structure"]
impl crate::Readable for AcnvP0Dst2Spec {}
#[doc = "`write(|w| ..)` method takes [`acnv_p0_dst2::W`](W) writer structure"]
impl crate::Writable for AcnvP0Dst2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ACNV_P0_DST2 to value 0x0005_0004"]
