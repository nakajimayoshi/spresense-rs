///Register `IBRD` reader
pub type R = crate::R<IbrdSpec>;
///Register `IBRD` writer
pub type W = crate::W<IbrdSpec>;
///Field `BAUD_DIVINT` reader - The integer baud rate divisor
pub type BaudDivintR = crate::FieldReader<u16>;
///Field `BAUD_DIVINT` writer - The integer baud rate divisor
pub type BaudDivintW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - The integer baud rate divisor
    #[inline(always)]
...
///`read()` method returns [`ibrd::R`](R) reader structure
impl crate::Readable for IbrdSpec {}
///`write(|w| ..)` method takes [`ibrd::W`](W) writer structure
impl crate::Writable for IbrdSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IBRD to value 0
