#[doc = "Register `DMACRawIntTCStatus` reader"]
pub type R = crate::R<DmacrawIntTcstatusSpec>;
#[doc = "Field `RawIntTCStatus` reader - Status of the terminal count interrupt prior to masking"]
...
#[doc = "`read()` method returns [`dmacraw_int_tcstatus::R`](R) reader structure"]
impl crate::Readable for DmacrawIntTcstatusSpec {}
#[doc = "`reset()` method sets DMACRawIntTCStatus to value 0"]
