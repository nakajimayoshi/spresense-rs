///Register `LPADC_D5` reader
pub type R = crate::R<LpadcD5Spec>;
///Register `LPADC_D5` writer
pub type W = crate::W<LpadcD5Spec>;
...
impl W {
    ///Bits 0:3 - FIFO watermark
    #[inline(always)]
    pub fn fifo_watermark(&mut self) -> FifoWatermarkW<'_, LpadcD5Spec> {
        FifoWatermarkW::new(self, 0)
    }
    ///Bit 5 - DMA handshake enable
    #[inline(always)]
    pub fn dma_hs_en(&mut self) -> DmaHsEnW<'_, LpadcD5Spec> {
        DmaHsEnW::new(self, 5)
    }
    ///Bits 8:11 - Frequency divider: 0=÷1 … 15=÷32768
    #[inline(always)]
    pub fn samp_ratio(&mut self) -> SampRatioW<'_, LpadcD5Spec> {
        SampRatioW::new(self, 8)
    }
    ///Bits 12:20 - PWM sync enables \[8:0\]
    #[inline(always)]
    pub fn samp_ratio2(&mut self) -> SampRatio2W<'_, LpadcD5Spec> {
        SampRatio2W::new(self, 12)
    }
}
/**LPADC ch2 (SEN_AIN4 / Arduino A2) sample-rate and watermark

You can [`read`](crate::Reg::read) this register and get [`lpadc_d5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpadc_d5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct LpadcD5Spec;
impl crate::RegisterSpec for LpadcD5Spec {
    type Ux = u32;
}
///`read()` method returns [`lpadc_d5::R`](R) reader structure
impl crate::Readable for LpadcD5Spec {}
///`write(|w| ..)` method takes [`lpadc_d5::W`](W) writer structure
impl crate::Writable for LpadcD5Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets LPADC_D5 to value 0x08
impl crate::Resettable for LpadcD5Spec {
