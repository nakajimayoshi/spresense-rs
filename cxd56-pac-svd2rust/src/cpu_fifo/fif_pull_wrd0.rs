...
#[doc = "`read()` method returns [`fif_pull_wrd0::R`](R) reader structure"]
impl crate::Readable for FifPullWrd0Spec {}
#[doc = "`write(|w| ..)` method takes [`fif_pull_wrd0::W`](W) writer structure"]
impl crate::Writable for FifPullWrd0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FIF_PULL_WRD0 to value 0"]
