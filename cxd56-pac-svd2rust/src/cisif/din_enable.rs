#[doc = "Register `DIN_ENABLE` reader"]
pub type R = crate::R<DinEnableSpec>;
#[doc = "Register `DIN_ENABLE` writer"]
pub type W = crate::W<DinEnableSpec>;
#[doc = "Field `ycin_enable` reader - "]
pub type YcinEnableR = crate::BitReader;
#[doc = "Field `ycin_enable` writer - "]
...
#[doc = "`read()` method returns [`din_enable::R`](R) reader structure"]
impl crate::Readable for DinEnableSpec {}
#[doc = "`write(|w| ..)` method takes [`din_enable::W`](W) writer structure"]
impl crate::Writable for DinEnableSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DIN_ENABLE to value 0"]
