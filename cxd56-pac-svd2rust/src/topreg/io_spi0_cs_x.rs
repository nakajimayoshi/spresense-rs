///Register `IO_SPI0_CS_X` reader
pub type R = crate::R<IoSpi0CsXSpec>;
///Register `IO_SPI0_CS_X` writer
pub type W = crate::W<IoSpi0CsXSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoSpi0CsXSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoSpi0CsXSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoSpi0CsXSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoSpi0CsXSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for SPI0_CS_X / UART1-TXD

You can [`read`](crate::Reg::read) this register and get [`io_spi0_cs_x::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_spi0_cs_x::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoSpi0CsXSpec;
impl crate::RegisterSpec for IoSpi0CsXSpec {
    type Ux = u32;
}
///`read()` method returns [`io_spi0_cs_x::R`](R) reader structure
impl crate::Readable for IoSpi0CsXSpec {}
///`write(|w| ..)` method takes [`io_spi0_cs_x::W`](W) writer structure
impl crate::Writable for IoSpi0CsXSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_SPI0_CS_X to value 0x0101_0100
impl crate::Resettable for IoSpi0CsXSpec {
