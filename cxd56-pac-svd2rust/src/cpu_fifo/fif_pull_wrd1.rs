///Register `FIF_PULL_WRD1` reader
pub type R = crate::R<FifPullWrd1Spec>;
///Register `FIF_PULL_WRD1` writer
...
///`read()` method returns [`fif_pull_wrd1::R`](R) reader structure
impl crate::Readable for FifPullWrd1Spec {}
///`write(|w| ..)` method takes [`fif_pull_wrd1::W`](W) writer structure
impl crate::Writable for FifPullWrd1Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FIF_PULL_WRD1 to value 0
