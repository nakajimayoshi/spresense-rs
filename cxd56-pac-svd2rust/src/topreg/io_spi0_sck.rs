///Register `IO_SPI0_SCK` reader
pub type R = crate::R<IoSpi0SckSpec>;
///Register `IO_SPI0_SCK` writer
pub type W = crate::W<IoSpi0SckSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoSpi0SckSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoSpi0SckSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoSpi0SckSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoSpi0SckSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for SPI0_SCK / UART1-RXD

You can [`read`](crate::Reg::read) this register and get [`io_spi0_sck::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_spi0_sck::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoSpi0SckSpec;
impl crate::RegisterSpec for IoSpi0SckSpec {
    type Ux = u32;
}
///`read()` method returns [`io_spi0_sck::R`](R) reader structure
impl crate::Readable for IoSpi0SckSpec {}
///`write(|w| ..)` method takes [`io_spi0_sck::W`](W) writer structure
impl crate::Writable for IoSpi0SckSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_SPI0_SCK to value 0x0101_0100
impl crate::Resettable for IoSpi0SckSpec {
