///Register `STAT_NORMAL_DESCRIPTOR_ADDRESS` reader
...
///`read()` method returns [`stat_normal_descriptor_address::R`](R) reader structure
impl crate::Readable for StatNormalDescriptorAddressSpec {}
///`reset()` method sets STAT_NORMAL_DESCRIPTOR_ADDRESS to value 0
