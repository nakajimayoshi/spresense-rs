#[doc = "Register `DMACIntErrClr` writer"]
pub type W = crate::W<DmacintErrClrSpec>;
#[doc = "Field `IntErrClr` writer - Interrupt error clear"]
...
#[doc = "`write(|w| ..)` method takes [`dmacint_err_clr::W`](W) writer structure"]
impl crate::Writable for DmacintErrClrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMACIntErrClr to value 0"]
