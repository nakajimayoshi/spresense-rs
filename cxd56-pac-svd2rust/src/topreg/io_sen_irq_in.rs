///Register `IO_SEN_IRQ_IN` reader
pub type R = crate::R<IoSenIrqInSpec>;
///Register `IO_SEN_IRQ_IN` writer
pub type W = crate::W<IoSenIrqInSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoSenIrqInSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoSenIrqInSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoSenIrqInSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoSenIrqInSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for SEN_IRQ_IN pin

You can [`read`](crate::Reg::read) this register and get [`io_sen_irq_in::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_sen_irq_in::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoSenIrqInSpec;
impl crate::RegisterSpec for IoSenIrqInSpec {
    type Ux = u32;
}
///`read()` method returns [`io_sen_irq_in::R`](R) reader structure
impl crate::Readable for IoSenIrqInSpec {}
///`write(|w| ..)` method takes [`io_sen_irq_in::W`](W) writer structure
impl crate::Writable for IoSenIrqInSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_SEN_IRQ_IN to value 0x0101_0100
impl crate::Resettable for IoSenIrqInSpec {
