...
impl Default for ACT_POS {
    #[inline(always)]
    fn default() -> ACT_POS {
        ACT_POS(0)
    }
}
impl core::fmt::Debug for ACT_POS {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ACT_POS")
...
impl Default for ACT_SIZE {
    #[inline(always)]
    fn default() -> ACT_SIZE {
        ACT_SIZE(0)
    }
}
impl core::fmt::Debug for ACT_SIZE {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ACT_SIZE")
...
impl Default for CIS_SIZE {
    #[inline(always)]
    fn default() -> CIS_SIZE {
        CIS_SIZE(0)
    }
}
impl core::fmt::Debug for CIS_SIZE {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CIS_SIZE")
...
#[cfg(feature = "defmt")]
impl defmt::Format for EXE_CMD {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "EXE_CMD {{ exe_cmd: {=bool:?} }}", self.exe_cmd())
    }
}
...
impl Default for INTR_STAT {
    #[inline(always)]
    fn default() -> INTR_STAT {
        INTR_STAT(0)
    }
}
impl core::fmt::Debug for INTR_STAT {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTR_STAT")
...
#[cfg(feature = "defmt")]
impl defmt::Format for INTR_STAT {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
