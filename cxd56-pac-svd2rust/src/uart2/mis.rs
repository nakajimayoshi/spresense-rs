...
///Field `RIMMIS` reader - nUARTRI modem masked interrupt status
pub type RimmisR = crate::BitReader;
///Field `CTSMMIS` reader - nUARTCTS modem masked interrupt status
pub type CtsmmisR = crate::BitReader;
///Field `DCDMMIS` reader - nUARTDCD modem masked interrupt status
pub type DcdmmisR = crate::BitReader;
///Field `DSRMMIS` reader - nUARTDSR modem masked interrupt status
pub type DsrmmisR = crate::BitReader;
///Field `RXMIS` reader - Receive masked interrupt status
pub type RxmisR = crate::BitReader;
///Field `TXMIS` reader - Transmit masked interrupt status
pub type TxmisR = crate::BitReader;
///Field `RTMIS` reader - Receive timeout masked interrupt status
pub type RtmisR = crate::BitReader;
///Field `FEMIS` reader - Framing error masked interrupt status
pub type FemisR = crate::BitReader;
///Field `PEMIS` reader - Parity error masked interrupt status
pub type PemisR = crate::BitReader;
///Field `BEMIS` reader - Break error masked interrupt status
pub type BemisR = crate::BitReader;
///Field `OEMIS` reader - Overrun error masked interrupt status
pub type OemisR = crate::BitReader;
impl R {
    ///Bit 0 - nUARTRI modem masked interrupt status
    #[inline(always)]
    pub fn rimmis(&self) -> RimmisR {
        RimmisR::new((self.bits & 1) != 0)
    }
    ///Bit 1 - nUARTCTS modem masked interrupt status
    #[inline(always)]
    pub fn ctsmmis(&self) -> CtsmmisR {
        CtsmmisR::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - nUARTDCD modem masked interrupt status
    #[inline(always)]
    pub fn dcdmmis(&self) -> DcdmmisR {
        DcdmmisR::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - nUARTDSR modem masked interrupt status
    #[inline(always)]
    ...
    ///Bit 7 - Framing error masked interrupt status
    #[inline(always)]
