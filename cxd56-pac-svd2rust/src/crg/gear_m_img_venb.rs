#[doc = "Register `GEAR_M_IMG_VENB` reader"]
pub type R = crate::R<GearMImgVenbSpec>;
#[doc = "Register `GEAR_M_IMG_VENB` writer"]
...
#[doc = "`read()` method returns [`gear_m_img_venb::R`](R) reader structure"]
impl crate::Readable for GearMImgVenbSpec {}
#[doc = "`write(|w| ..)` method takes [`gear_m_img_venb::W`](W) writer structure"]
impl crate::Writable for GearMImgVenbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GEAR_M_IMG_VENB to value 0"]
