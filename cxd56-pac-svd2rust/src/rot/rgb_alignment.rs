///Register `RGB_ALIGNMENT` reader
pub type R = crate::R<RgbAlignmentSpec>;
///Register `RGB_ALIGNMENT` writer
...
///Field `FORMAT` reader - RGB Format
...
///Field `FORMAT` writer - RGB Format
...
///`read()` method returns [`rgb_alignment::R`](R) reader structure
impl crate::Readable for RgbAlignmentSpec {}
///`write(|w| ..)` method takes [`rgb_alignment::W`](W) writer structure
impl crate::Writable for RgbAlignmentSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RGB_ALIGNMENT to value 0
