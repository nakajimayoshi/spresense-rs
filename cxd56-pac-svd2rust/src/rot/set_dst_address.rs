#[doc = "Register `SET_DST_ADDRESS` reader"]
pub type R = crate::R<SetDstAddressSpec>;
#[doc = "Register `SET_DST_ADDRESS` writer"]
...
#[doc = "`read()` method returns [`set_dst_address::R`](R) reader structure"]
impl crate::Readable for SetDstAddressSpec {}
#[doc = "`write(|w| ..)` method takes [`set_dst_address::W`](W) writer structure"]
impl crate::Writable for SetDstAddressSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SET_DST_ADDRESS to value 0"]
