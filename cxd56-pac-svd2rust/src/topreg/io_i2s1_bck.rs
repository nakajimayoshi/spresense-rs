///Register `IO_I2S1_BCK` reader
pub type R = crate::R<IoI2s1BckSpec>;
///Register `IO_I2S1_BCK` writer
pub type W = crate::W<IoI2s1BckSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoI2s1BckSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoI2s1BckSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoI2s1BckSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoI2s1BckSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for I2S1_BCK pin

You can [`read`](crate::Reg::read) this register and get [`io_i2s1_bck::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_i2s1_bck::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoI2s1BckSpec;
impl crate::RegisterSpec for IoI2s1BckSpec {
    type Ux = u32;
}
///`read()` method returns [`io_i2s1_bck::R`](R) reader structure
impl crate::Readable for IoI2s1BckSpec {}
///`write(|w| ..)` method takes [`io_i2s1_bck::W`](W) writer structure
impl crate::Writable for IoI2s1BckSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_I2S1_BCK to value 0x0101_0100
impl crate::Resettable for IoI2s1BckSpec {
