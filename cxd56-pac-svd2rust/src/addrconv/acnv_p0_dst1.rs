...
///`read()` method returns [`acnv_p0_dst1::R`](R) reader structure
impl crate::Readable for AcnvP0Dst1Spec {}
///`write(|w| ..)` method takes [`acnv_p0_dst1::W`](W) writer structure
impl crate::Writable for AcnvP0Dst1Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets ACNV_P0_DST1 to value 0x0003_0002
