///Register `IO_EMMC_CLK` reader
pub type R = crate::R<IoEmmcClkSpec>;
///Register `IO_EMMC_CLK` writer
pub type W = crate::W<IoEmmcClkSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoEmmcClkSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoEmmcClkSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoEmmcClkSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoEmmcClkSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for EMMC_CLK / SPI5_SCK pin

You can [`read`](crate::Reg::read) this register and get [`io_emmc_clk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_emmc_clk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoEmmcClkSpec;
impl crate::RegisterSpec for IoEmmcClkSpec {
    type Ux = u32;
}
///`read()` method returns [`io_emmc_clk::R`](R) reader structure
impl crate::Readable for IoEmmcClkSpec {}
///`write(|w| ..)` method takes [`io_emmc_clk::W`](W) writer structure
impl crate::Writable for IoEmmcClkSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_EMMC_CLK to value 0x0101_0100
impl crate::Resettable for IoEmmcClkSpec {
