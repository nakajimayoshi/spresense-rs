...
#[doc = "`read()` method returns [`gear_per_usb::R`](R) reader structure"]
impl crate::Readable for GearPerUsbSpec {}
#[doc = "`write(|w| ..)` method takes [`gear_per_usb::W`](W) writer structure"]
impl crate::Writable for GearPerUsbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GEAR_PER_USB to value 0x02"]
