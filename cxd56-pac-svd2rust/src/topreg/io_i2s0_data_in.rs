///Register `IO_I2S0_DATA_IN` reader
pub type R = crate::R<IoI2s0DataInSpec>;
///Register `IO_I2S0_DATA_IN` writer
pub type W = crate::W<IoI2s0DataInSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoI2s0DataInSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoI2s0DataInSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoI2s0DataInSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoI2s0DataInSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for I2S0_DATA_IN pin

You can [`read`](crate::Reg::read) this register and get [`io_i2s0_data_in::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_i2s0_data_in::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoI2s0DataInSpec;
impl crate::RegisterSpec for IoI2s0DataInSpec {
    type Ux = u32;
}
///`read()` method returns [`io_i2s0_data_in::R`](R) reader structure
impl crate::Readable for IoI2s0DataInSpec {}
///`write(|w| ..)` method takes [`io_i2s0_data_in::W`](W) writer structure
impl crate::Writable for IoI2s0DataInSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_I2S0_DATA_IN to value 0x0101_0100
impl crate::Resettable for IoI2s0DataInSpec {
