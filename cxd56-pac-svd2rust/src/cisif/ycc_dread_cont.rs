///Register `YCC_DREAD_CONT` reader
pub type R = crate::R<YccDreadContSpec>;
///Register `YCC_DREAD_CONT` writer
...
///`read()` method returns [`ycc_dread_cont::R`](R) reader structure
impl crate::Readable for YccDreadContSpec {}
///`write(|w| ..)` method takes [`ycc_dread_cont::W`](W) writer structure
impl crate::Writable for YccDreadContSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets YCC_DREAD_CONT to value 0
