...
#[doc = "`read()` method returns [`gear_ahb::R`](R) reader structure"]
impl crate::Readable for GearAhbSpec {}
#[doc = "`write(|w| ..)` method takes [`gear_ahb::W`](W) writer structure"]
impl crate::Writable for GearAhbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GEAR_AHB to value 0x0001_0002"]
