#[doc = "Register `ADDRESS_DESCRIPTOR_START` reader"]
pub type R = crate::R<AddressDescriptorStartSpec>;
#[doc = "Register `ADDRESS_DESCRIPTOR_START` writer"]
pub type W = crate::W<AddressDescriptorStartSpec>;
#[doc = "Field `MSEL` reader - must be 1"]
pub type MselR = crate::BitReader;
#[doc = "Field `MSEL` writer - must be 1"]
pub type MselW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DA` reader - Descriptor Address"]
pub type DaR = crate::FieldReader<u32>;
#[doc = "Field `DA` writer - Descriptor Address"]
...
impl R {
    ...
    #[doc = "Bits 4:31 - Descriptor Address"]
    #[inline(always)]
    pub fn da(&self) -> DaR {
...
#[doc = "`read()` method returns [`address_descriptor_start::R`](R) reader structure"]
impl crate::Readable for AddressDescriptorStartSpec {}
#[doc = "`write(|w| ..)` method takes [`address_descriptor_start::W`](W) writer structure"]
impl crate::Writable for AddressDescriptorStartSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADDRESS_DESCRIPTOR_START to value 0"]
