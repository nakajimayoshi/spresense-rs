///Register `DMACSoftLSReq` reader
pub type R = crate::R<DmacsoftLsreqSpec>;
///Register `DMACSoftLSReq` writer
pub type W = crate::W<DmacsoftLsreqSpec>;
///Field `SoftLSReq` reader - Software last single request
pub type SoftLsreqR = crate::FieldReader<u16>;
///Field `SoftLSReq` writer - Software last single request
pub type SoftLsreqW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Software last single request
    #[inline(always)]
...
///`read()` method returns [`dmacsoft_lsreq::R`](R) reader structure
impl crate::Readable for DmacsoftLsreqSpec {}
///`write(|w| ..)` method takes [`dmacsoft_lsreq::W`](W) writer structure
impl crate::Writable for DmacsoftLsreqSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DMACSoftLSReq to value 0
