...
impl RegisterBlock {
    ...
    #[doc = "0x94 - "]
    #[inline(always)]
    pub const fn sspcs(&self) -> &Sspcs {
        &self.sspcs
    }
    #[doc = "0x98 - "]
    #[inline(always)]
    pub const fn slavetype(&self) -> &Slavetype {
        &self.slavetype
    }
}
...
pub mod sspdmacr;
#[doc = "CSMODE (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`csmode::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csmode::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@csmode`] module"]
#[doc(alias = "CSMODE")]
pub type Csmode = crate::Reg<csmode::CsmodeSpec>;
#[doc = ""]
pub mod csmode;
#[doc = "SSPCS (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`sspcs::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sspcs::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sspcs`] module"]
#[doc(alias = "SSPCS")]
pub type Sspcs = crate::Reg<sspcs::SspcsSpec>;
#[doc = ""]
pub mod sspcs;
#[doc = "SLAVETYPE (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`slavetype::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`slavetype::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@slavetype`] module"]
#[doc(alias = "SLAVETYPE")]
pub type Slavetype = crate::Reg<slavetype::SlavetypeSpec>;
#[doc = ""]
pub mod slavetype;
