///Register `CMD_DESCRIPTOR` writer
...
pub enum CommandType {
    ///0: No Operation
    Nop = 0,
    ///1: Normal Descriptor Set and Run
    Run = 1,
    ///3: Stop Descriptor
    Stop = 3,
}
...
///`write(|w| ..)` method takes [`cmd_descriptor::W`](W) writer structure
impl crate::Writable for CmdDescriptorSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CMD_DESCRIPTOR to value 0
