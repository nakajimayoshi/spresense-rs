///Register `IO_UART2_TXD` reader
pub type R = crate::R<IoUart2TxdSpec>;
///Register `IO_UART2_TXD` writer
pub type W = crate::W<IoUart2TxdSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoUart2TxdSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoUart2TxdSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoUart2TxdSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoUart2TxdSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for UART2 TXD pin

You can [`read`](crate::Reg::read) this register and get [`io_uart2_txd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_uart2_txd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoUart2TxdSpec;
impl crate::RegisterSpec for IoUart2TxdSpec {
    type Ux = u32;
}
///`read()` method returns [`io_uart2_txd::R`](R) reader structure
impl crate::Readable for IoUart2TxdSpec {}
///`write(|w| ..)` method takes [`io_uart2_txd::W`](W) writer structure
impl crate::Writable for IoUart2TxdSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_UART2_TXD to value 0x0101_0100
impl crate::Resettable for IoUart2TxdSpec {
