...
///`read()` method returns [`fif_push_wrd0::R`](R) reader structure
impl crate::Readable for FifPushWrd0Spec {}
///`write(|w| ..)` method takes [`fif_push_wrd0::W`](W) writer structure
impl crate::Writable for FifPushWrd0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FIF_PUSH_WRD0 to value 0
