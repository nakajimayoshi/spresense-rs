...
///`read()` method returns [`dmacc0src_addr::R`](R) reader structure
impl crate::Readable for Dmacc0srcAddrSpec {}
///`write(|w| ..)` method takes [`dmacc0src_addr::W`](W) writer structure
impl crate::Writable for Dmacc0srcAddrSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DMACC0SrcAddr to value 0
